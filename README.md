...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-y4j0u-8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-y4j0u-8.containers.anotherwebservice.com/
...
```
git clone git@github.com:matthewglhrm/container-y4j0u-8.git
cd container-y4j0u-8
```
...
```
docker attach container-y4j0u-8
```
